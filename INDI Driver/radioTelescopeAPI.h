 ...
 *
 * This file contains the definitions for a C++ implementatiom of the Radio Telescope API.
...
class radioTelescopeAPI
{
    public:
        ...
        radioTelescopeAPI();
        virtual ~radioTelescopeAPI() = default;
        ...
        // Radio Telescope mount status variables
    ...
    private:
        ...
        virtual int radioTelescope_tty_read(int fd, char *buf, int nbytes, int timeout, int *nbytes_read) = 0;
        virtual int radioTelescope_tty_read_section(int fd, char *buf, char stop_char, int timeout, int *nbytes_read) = 0;
        virtual int radioTelescope_tty_write(int fd, const char *buffer, int nbytes, int *nbytes_written) = 0;
        //    virtual int radioTelescope_tty_write_string(int fd, const char * buffer, int *nbytes_written) = 0;
        //    virtual int radioTelescope_tty_connect(const char *device, int bit_rate, int word_size, int parity, int stop_bits, int *fd) = 0;
        //    virtual int radioTelescope_tty_disconnect(int fd) = 0;
        //    virtual void radioTelescope_tty_error_msg(int err_code, char *err_msg, int err_msg_len) = 0;
        //    virtual int radioTelescope_tty_timeout(int fd, int timeout) = 0;*/
        int MyPortFD { 0 };
