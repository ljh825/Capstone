 ...
 *
 * This file contains the definitions for a C++ implementatiom of a INDI telescope driver using the Radio Telescope API.
...
class radioTelescope : public radioTelescopeAPI,
                           public INDI::Telescope,
                           public INDI::GuiderInterface
{
  public:
    radioTelescope();
    virtual ~radioTelescope() = default;
...
private:
    ...
    // Overrides for the pure virtual functions in radioTelescopeAPI
    virtual int radioTelescope_tty_read(int fd, char *buf, int nbytes, int timeout, int *nbytes_read) override;
    virtual int radioTelescope_tty_read_section(int fd, char *buf, char stop_char, int timeout, int *nbytes_read) override;
    virtual int radioTelescope_tty_write(int fd, const char *buffer, int nbytes, int *nbytes_written) override;
